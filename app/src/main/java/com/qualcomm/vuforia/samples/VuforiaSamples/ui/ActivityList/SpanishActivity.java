...
public class SpanishActivity extends Activity implements View.OnClickListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        mTranslateButton.setText("Traducir (Translate)");
                        ...
                        textViewHandler.post(new Runnable() {
                            ...
                            public void run() {
                               ...
                               // Toast.makeText(getApplicationContext(), translation.getTranslatedText(),
                                ...
                                mDetectedWord.setText("La palabra traducida es (The translated word is) : " +translated_word);
                                // }
                            }
                        });
                        return null;
    ...
    public void speak(){
       ...
       //mTTS.speak(text,TextToSpeech.QUEUE_FLUSH,null);
        ...
        mTTS.speak("The detected word is ..." +detected_word +"...Its Spanish translation is... " +translated_word,TextToSpeech.QUEUE_FLUSH,null );
