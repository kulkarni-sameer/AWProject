...
public class FrenchActivity extends Activity implements View.OnClickListener
{
        ...
        mTTS=new TextToSpeech(this, new TextToSpeech.OnInitListener() { //TextToSpeech Class
            ...
            public void onInit(int i) {
                if(i==TextToSpeech.SUCCESS){   //if inistializatio is successful
                    int lang=mTTS.setLanguage(Locale.FRENCH);  //Language setting up
                    ...
                    protected Void doInBackground(Void... params) {
                        ...
                        textViewHandler.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                mDetectedWord.setText("Le mot traduit est (The translated word is) : " +translated_word);
                                // }
                            }
                        });
                        return null;
    ...
    public void speak(){
        ...
        mTTS.speak("The detected word is ..." +detected_word +"...Its French translation is... " +translated_word,TextToSpeech.QUEUE_FLUSH,null );
