...
public class GermanActivity extends Activity implements View.OnClickListener
{
        ...
        mTTS=new TextToSpeech(this, new TextToSpeech.OnInitListener() { //TextToSpeech Class
            ...
            public void onInit(int i) {
                if(i==TextToSpeech.SUCCESS){   //if inistializatio is successful
                    int lang=mTTS.setLanguage(Locale.GERMAN);  //Language setting up
                    ...
                    protected Void doInBackground(Void... params) {
                        ...
                        textViewHandler.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                mDetectedWord.setText("Das übersetzte Wort ist (The translated word is) : " +translated_word);
                                // }
                            }
                        });
                        return null;
    ...
    public void speak(){
        ...
        mTTS.speak("The detected word is ..." +detected_word +"...Its German translation is... " +translated_word,TextToSpeech.QUEUE_FLUSH,null );
