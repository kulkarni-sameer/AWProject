...
//import com.qualcomm.vuforia.samples.SampleApplication.utils.BowlAndSpoonObject;
...
public class ImageTargetRenderer1 implements GLSurfaceView.Renderer
{
    ...
    // private BowlAndSpoonObject mTeapot;
    ...
    public ImageTargetRenderer1(ImageTargets activity,
    ...
    private void renderFrame()
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
        {
            ...
            if (mActivity.isExtendedTrackingActive())
            {
                ...
                GLES20.glDrawArrays(GLES20.GL_TRIANGLES, 0, 450);
