    ...
    SampleAppMenuInterface
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.camera_overlay_textreco);
        System.out.println("In on Create Reco.java");
    ...
    public void onClickBtn(View v)
    {
        ...
        GoogleAPI.setKey("AIzaSyDH90WqHDnkbF_nyTbxwMWBRjv2t7-zqYg");
       // String translatedText="Dumbo";
