...
public class PortugueseActivity extends Activity implements View.OnClickListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        mWelcomeTitle.setText("Bem Vinda, " +username +"!");
        ...
        mTTS=new TextToSpeech(this, new TextToSpeech.OnInitListener() { //TextToSpeech Class
            ...
            public void onInit(int i) {
                if(i==TextToSpeech.SUCCESS){   //if inistializatio is successful
                    int lang=mTTS.setLanguage(new Locale("pt_PT"));  //Language setting up
